...
import org.loon.game.simple.j25d.ResourceLoader;
...
public class MapConfig {
	...
	public static List loadList(final String fileName) throws IOException {
		InputStream in = ResourceLoader.getResourceToInputStream(fileName);
