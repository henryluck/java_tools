...
public class WebProcessor {
     ...
     * @throws Exception
     */
    public List<CompanyInfo> parseWeb(String key, String webURL) {
        try {
            ...
            List<String> alist = getMatchList(page, ConfigUtil.getComInfoHtmlListByKey(key));
     ...
     */
    private IParser getParser(String key) throws InstantiationException, IllegalAccessException,
    ...
    public static  void printPage(String webURL) throws IOException{
